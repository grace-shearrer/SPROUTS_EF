...
#Load data
```{r}
dat9<-read.delim("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST09.txt", header = T, sep = "\t")
dat9 <- dat9[-c(1), ]
...
dat4 <- read.delim("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST04.txt", header=TRUE, sep="\t")
...
```{r}
data<-readdat("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST09.txt","~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST04.txt")
dim(data)

hei_data<-HEI("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST09.txt","~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST04.txt")
```

...
#Load data
```{r}
dat9<-read.table("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MST09.txt", header = T, sep = "\t")
dat9 <- dat9[-c(1), ]

dat4<-read.table("~/Google Drive/SPROUTS_EF/data/SPROUTS/NDSR/Final Dataset Uploads from DPAC to SPROUTS Staff Task 1/Q4-20 and last Phase1 March 2021/4SpMom20MSTd/", sep = ",")
dat4 <- dat4[-c(1), ]
dat$Total.Polyunsaturated.Fatty.Acids..PUFA...g.
dat<-join(dat9,dat4)

dat[4:175] <- sapply( dat[4:175], as.numeric )
dim(dat)

Var_int<-c("Participant.ID","Date.of.Intake", "VEG0100","VEG0200","VEG0300","VEG0400","VEG0800","VEG0450","VEG0700","VEG0600","VEG0900","VEG0500", "VEG0100","VEG0700", 
...
dat$heisfa <- ifelse(is.na(dat$sfa_perc),
